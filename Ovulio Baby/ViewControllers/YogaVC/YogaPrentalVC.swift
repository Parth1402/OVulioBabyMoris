...
class YogaPrentalVC: UIViewController {

    var customNavBarView: CustomNavigationBar?
    var tableView = UITableView(frame: CGRect.zero, style: .plain)
    var yogaFertilityData = YogaPrentalDataManager.shared.retrieveYogaPrentalModel()
...
extension YogaPrentalVC: UITableViewDataSource, UITableViewDelegate {
        ...
        cell.yogaCardDidTapped = { selectedCardIndex in
            ...
            if isUserProMember() {
                ...
                vc.saveAfterScratcingCard = {
                    YogaPrentalDataManager.shared.saveYogaPrentalModel(self.yogaFertilityData)
