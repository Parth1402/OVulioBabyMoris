//
//  NameGenetareGenderSelectionCell.swift
//  Ovulio Baby
//
...
class NameGenetareGenderSelectionCell: UITableViewCell {
...
// MARK: Actions
extension NameGenetareGenderSelectionCell {
        ...
        if let buttonTag = sender.view?.tag {
            ...
            case 1:
                boyContainerView.showAnimation({
                    ...
                    if NameGenerateManager.shared.selectedGender == .boy {
                        NameGenerateDataBeforeSaving.isGenderChangeed = false
                    }else{
                        NameGenerateDataBeforeSaving.selectedGender = .boy
                        NameGenerateManager.shared.selectedGender = .boy
                        NameGenerateDataBeforeSaving.isGenderChangeed = true
                    }
            ...
            case 2:
                girlContainerView.showAnimation({
                    ...
                    if NameGenerateManager.shared.selectedGender == .girl {
                        NameGenerateDataBeforeSaving.isGenderChangeed = false
                    }else{
                        NameGenerateDataBeforeSaving.selectedGender = .girl
                        NameGenerateManager.shared.selectedGender = .girl
                        NameGenerateDataBeforeSaving.isGenderChangeed = true
                    }
                    if let action = self.isFieldChanged {
                        action()
            ...
            case 3:
                doesntMatterContainerView.showAnimation({
                    ...
                    if NameGenerateManager.shared.selectedGender == .doesntMatter {
                        NameGenerateDataBeforeSaving.isGenderChangeed = false
                    }else{
                        NameGenerateDataBeforeSaving.selectedGender = .doesntMatter
                        NameGenerateManager.shared.selectedGender = .doesntMatter
                        NameGenerateDataBeforeSaving.isGenderChangeed = true
                    }
                    if let action = self.isFieldChanged {
                        action()
...
extension NameGenetareGenderSelectionCell {
    ...
    func makeBoyGoalView() {
        ...
        boyBorderView.layer.borderWidth = NameGenerateManager.shared.selectedGender == .boy ? 2 : 0
    ...
    func makeGirlGoalView() {
        ...
        if DeviceSize.isiPadDevice {
            NSLayoutConstraint.activate([
                ...
                girlContainerView.leadingAnchor.constraint(equalTo: boyContainerView.trailingAnchor,constant: 16),
        ...
        girlBorderView.layer.borderWidth = NameGenerateManager.shared.selectedGender == .girl ? 2 : 0
    ...
    func makeDoesntMatterGoalView() {
        ...
        if DeviceSize.isiPadDevice {
            NSLayoutConstraint.activate([
                doesntMatterContainerView.leadingAnchor.constraint(equalTo: girlContainerView.trailingAnchor,constant: 16),
        ...
        doesntMatterBorderView.layer.borderWidth = NameGenerateManager.shared.selectedGender == .doesntMatter ? 2 : 0
        ...
        let boyLabel = UILabel()
        boyLabel.font = UIFont.mymediumSystemFont(ofSize: DeviceSize.isiPadDevice ? 16 : 14)
        boyLabel.text = "NameGenerateVC.gender.unisex.text"~
